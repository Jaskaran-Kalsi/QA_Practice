...
public class AndroidBaseTest {
    ...
    public void cloudDriver(String config_file, String environment) throws Exception {
        ...
        JSONObject config = (JSONObject) parser.parse(new FileReader("src/test/resources/android/conf/" + config_file));
        ...
        driver = new AndroidDriver<AndroidElement>(new URL("http://"
                + username
                + ":"
                + accessKey
                + "@"
